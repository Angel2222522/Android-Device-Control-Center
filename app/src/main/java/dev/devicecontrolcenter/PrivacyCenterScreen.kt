            ...
            Card(colors = CardDefaults.cardColors(containerColor = MaterialTheme.colorScheme.surface), shape = androidx.compose.foundation.shape.RoundedCornerShape(24.dp)) {
                Column(modifier = Modifier.padding(18.dp), verticalArrangement = Arrangement.spacedBy(10.dp)) {
                    ...
                    AccessSettingRow(
                        ...
                        detail = "Επιτρέπει ιστορικό χρήσης εφαρμογών και στατιστικά κίνησης όπου τα παρέχει το Android. Τα στοιχεία χώρου ανά εφαρμογή (APK/data/cache) εμφανίζονται ξεχωριστά μόνο όπου τα παρέχει το Android/OEM. Δεν ενεργοποιείται από την εφαρμογή.",
                        onOpen = {
                            onOpenUsageSettings()
