...
Phase 1 foundation and the RAM/thermal/storage/access snapshot are verified in CI and on the target Android 16 phone. The factual battery snapshot and truthful unavailable-voltage handling are physically verified; this target does not expose a usable voltage measurement.
